...
function initEffect() {
  ...
  const update = () => {
    ...
    // Short runway: this band lives in a sticky rail, so once the rail pins
    // its top stops moving. A 0.65vh runway left the wipe frozen partway
    // through for the whole of the section; 0.35vh completes while the
    // panel is still well inside the viewport.
