...
function initEffect() {
  ...
  const update = () => {
    ...
    for (const el of targets) {
      ...
      // Resolve within the bottom 15% of the viewport: a wider band left the
      // whole lower half of the page blurred whenever scrolling stopped, and
      // the last screenful could never rise far enough to sharpen at all.
