...
function initSlotVideo() {
  // The modal's clip is driven by the dialog's open/close, not by viewport
  // intersection — it would otherwise decode behind [hidden].
...
function initVideoModal() {
  ...
  const modal = document.getElementById('crust-film');
