 ...
 * The heading splits into per-character spans that rise in sequence.
 * The plain string stays available to assistive tech and to no-JS.
 * ------------------------------------------------------------------ */
...
function initEffect() {
  ...
  if (!heading || reduceMotion.matches) return;
