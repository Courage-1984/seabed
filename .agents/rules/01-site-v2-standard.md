...
trigger: glob
glob: sites/**
description: Site v2 folder layout, meta.json schema, and asset path contract for hub sites under YYYY-MM chronological buckets
---

# Site v2 standard

Every new or upgraded site must follow this layout, structured under a chronological Year-Month subfolder (`sites/<YYYY-MM>/<kebab-slug>/`):
