...
1. **Run Sweep:** Execute `node scripts/qa_sweep.js` from the repository root without any arguments. This runs Puppeteer across all `sites/*/index.html` (and other pages).
